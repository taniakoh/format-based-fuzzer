...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert Neuzz benchmark outputs into project-style plot_data.")
    ...
    with output.open("w", encoding="utf-8", newline="") as handle:
        ...
        for checkpoint in checkpoints:
            while event_index < len(events) and events[event_index].relative_time_sec <= checkpoint:
                ...
                elif event.category == "target_bug":
