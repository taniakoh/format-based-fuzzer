...
from cidrize_benchmark_common import analyze_cidrize_input
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Measure AFL cidrize corpus results with oracle-based bug breakdown.")
    ...
    for path in inputs:
        outcome = analyze_cidrize_input(path.read_bytes())
    ...
    print("=" * 60)
    print("AFL cidrize corpus benchmark summary")
    print("=" * 60)
