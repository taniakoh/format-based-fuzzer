...
from ipv4_benchmark_common import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Replay one IPv4 input with project-style wording.")
    parser.add_argument("--input-file", help="Path to a file containing the raw IPv4 bytes to test.")
    parser.add_argument("--ipstr", help="IPv4 string to test directly.")
    ...
    outcome = analyze_ipv4_input(data)
