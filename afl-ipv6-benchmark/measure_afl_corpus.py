...
from ipv6_benchmark_common import analyze_ipv6_input
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Measure AFL IPv6 corpus results with oracle-based bug breakdown.")
    ...
    for path in inputs:
        outcome = analyze_ipv6_input(path.read_bytes())
    ...
    print("=" * 60)
    print("AFL IPv6 corpus benchmark summary")
    print("=" * 60)
