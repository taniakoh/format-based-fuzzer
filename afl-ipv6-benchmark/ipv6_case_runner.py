...
from ipv6_benchmark_common import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Replay one IPv6 input with project-style wording.")
    parser.add_argument("--input-file", help="Path to a file containing the raw IPv6 bytes to test.")
    parser.add_argument("--ipstr", help="IPv6 string to test directly.")
    ...
    outcome = analyze_ipv6_input(data)
